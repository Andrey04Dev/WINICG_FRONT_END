...
const FormRisksAdd = () => {
  ...
  return (
    ...
    >
        ...
        <Input error={errors.origen?.message} type={"text"} name={"origen"}label={"Escriba el origen del riesgo"} placeholder={"Escriba el origen del riesgo"}/>
        ...
        <Input error={errors.source_risk?.message} type={"text"} name={"source_risk"}label={"Escriba la fuente del riesgo"} placeholder={"Escriba la fuente del riesgo"}/>
