...
const GetNoAccordance = () => {
  const arrayHeaderPosiiion = ["idaccordance","processname","audit_name","project","name_no_accordance","kind","ranking","description","state","audit_detect", "createdate", "updatedate"];
